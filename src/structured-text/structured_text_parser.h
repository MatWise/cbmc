...
#ifndef CPROVER_STRUCTURED_TEXT_STRUCTURED_TEXT_PARSER_H
#define CPROVER_STRUCTURED_TEXT_STRUCTURED_TEXT_PARSER_H

#include <util/parser.h>

#include "structured_text_parse_tree.h"

// Defined in structured_text_y.tab.cpp.
int yystructured_textparse();

/// Responsible for starting the parse process and to translate the result into
/// a structured_text_parse_treet. This parser works by using the expression
...
/// expression tree structure into a structured_text_parse_treet::functiont or
/// structured_text_parse_treet::function_blockt and add it to the
/// structured_text_parse_treet. See the implementation of scanner.l and
/// parser.y for details about how and when the stack operations are performed.
class structured_text_parsert : public parsert
{
public:
  ...
  bool parse() override
  {
    return yystructured_textparse() != 0;
  }
  ...
  void swap_tree(structured_text_parse_treet &other);
...
extern structured_text_parsert structured_text_parser;
...
void structured_text_scanner_init();

#endif // CPROVER_STRUCTURED_TEXT_STRUCTURED_TEXT_PARSER_H
